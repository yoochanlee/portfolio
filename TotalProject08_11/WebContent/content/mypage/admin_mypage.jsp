                ...
                <div class="imgBox">
                    <div class="row">
                        ...
                        <div class="textBox col-sm-9">
                            ...
                            <div class="linkBox">
                                <a href="${pageContext.request.contextPath}/myadmin_review.do">내가 쓴 글 <span class="badge">5</span></a>
                                <a href="${pageContext.request.contextPath}/content/user/user_edit.jsp">회원정보 수정</a> 
                                <!-- if -->
