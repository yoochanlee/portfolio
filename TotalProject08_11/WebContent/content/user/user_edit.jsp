...
function update(f){
	...
	var m_photo = f.m_photo.value.trim();
			...
			<div id="userJoin">
		        <div class="inner-in">
		            ...
		            <div class="profileplace">
		                <img class="img-responsive center-block" id="m_photo" src="${pageContext.request.contextPath}/img/mypage/mypage.jpg">
		            </div>
		            ...
		            <form method="post" enctype="multipart/form-data">
		                ...
		                <table class="table">
		                    <tr>
		                        ...
		                        <td class="col-sm-9">
		                            <div class="col-sm-8">
		                                <input type="text" name="m_id" id="m_id" value="${vo.m_id }" class="form-control" readonly="readonly">
		                            </div>
		                    ...
		                    <tr>
		                        ...
		                        <td class="col-sm-9"><input type="password" name="m_pwd" value="${vo.m_pwd }" id="m_pwd" class="form-control"></td>
		                    </tr>
		
		                    <tr>
		                        <th class="col-sm-3">비밀번호 확인</th>
		                        <td class="col-sm-9"><input type="password" name="c_pwd" value="${vo.m_pwd }" id="c_pwd" class="form-control"></td>
		                    </tr>
		
		                    <tr>
		                        <th class="col-sm-3">이름</th>
		                        <td class="col-sm-9"><input type="text" name="m_name" value="${vo.m_name }" id="m_name" class="form-control"></td>
		                    </tr>
		                    ...
		                    <tr>
		                        ...
		                        <td class="col-sm-9">
		                            <label class="radio-inline">
		                                <input type="radio" name="m_gender" id="m_man" value="남성">남성
		                            </label>
		                            <label class="radio-inline">
		                                <input type="radio" name="m_gender" id="m_woman" value="여성">여성
		                            </label>
		                        </td>
		                    </tr>
		                    ...
		                    <tr>
		                        ...
		                        <td class="col-sm-9">
		                            ...
		                            <div class="col-sm-4">
		                                <input type="text" name="m_tel2" id="m_tel2" class="form-control">
		                            </div>
		
		                            <div class="col-sm-4">
		                                <input type="text" name="m_tel3" id="m_tel3" class="form-control">
		                            </div>
		                        </td>
		                    </tr>
		                    ...
		                    <tr>
		                        ...
		                        <td class="col-sm-9"><input class="form-control" type="text" name="m_email" maxlength="30" value="${vo.m_email }"></td>
		                    </tr>
		
		                    <tr>
		                        <th class="col-sm-3">Image</th>
		                        <td class="col-sm-9"><input class="form-control" type="file" name="m_photo" maxlength="30" value="${vo.m_photo }"></td>
		                    </tr>
		
		                    <tr class="btnBox">
		                    	<td colspan="2"><input id="nut" type="button" class="btn btn-info" value="수정" onclick="update(this.form);">
		                    	<input id="nut" type="button" class="btn btn-danger" value="탈퇴" onclick="del(${vo.m_idx});">
		                    	</td>
