    	...
    	<div class="cafe_imgBox swiper-container">
    		<ul class="swiper-wrapper">
    			<li class="swiper-slide">
    				<img alt="cafe 이미지" src="${pageContext.request.contextPath}/upload/${vo.c_photo}">
    			</li>
		    	...
		    	<ul class="reviewUser">
		    		<li>
		    			<div class="cafeReview">
						    ...
						    <div class="review">
						      <span class="point"><img id="images1" src="${pageContext.request.contextPath}/grade/${review.image}.png"></span>	
