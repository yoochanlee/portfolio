        ...
        <ul>
            <li>
                <a href="${pageContext.request.contextPath}/cafe/cafe_sort.do?c_addr=&c_i=0">
                    <img src="${pageContext.request.contextPath}/img/category/05.jpg" class="img-rounded" alt="Cinque Terre">
                    <h3>이번주 베스트 </h3>
                </a>
            </li>
            ...
            <li>
                <a href="${pageContext.request.contextPath}/cafe/cafe_sort.do?c_addr=부산&c_i=0">
                    <img src="./img/category/05.jpg" class="img-rounded" alt="Cinque Terre">
                    <h3>부산은 여기로</h3>
                </a>
            </li>
        </ul>
