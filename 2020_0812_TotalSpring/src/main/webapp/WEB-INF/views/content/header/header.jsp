	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="${ pageContext.request.contextPath }/member/mypage_list.do"><span class="glyphicon glyphicon-user"></span> 마이페이지 </a></li>
				...
				<li><a>${user.m_name }님 환영합니다</a></li>
				<li><a href="${ pageContext.request.contextPath }/member/mypage_list.do"><span class="glyphicon glyphicon-user"></span> 관리자페이지 </a></li>
				<li><a href="${ pageContext.request.contextPath }/logout.do"><span class="glyphicon glyphicon-log-out"></span>로그아웃</a></li>
