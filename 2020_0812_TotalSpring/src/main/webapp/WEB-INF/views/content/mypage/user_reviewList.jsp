...
function del2(r_idx){
	...
	location.href="${pageContext.request.contextPath}/review/review_delete.do?r_idx=" + r_idx;
}

function review_update1(r_idx){
	location.href="${pageContext.request.contextPath}/review/review_update_form.do?r_idx=" + r_idx;
}
...
<div class="reviewBox">
     <h3 class="linkBox"><a href="admin_mypage.jsp?admin=review">오늘 신규 리뷰 <span class="badge">${list.size() }</span></a></h3>
