...
<body>
    ...
    <div id="content" >
    	<div class="jumbotron" id="main_text">
		    <h2>우리동네 카페 베스트</h2>      
		    <p>각 ${param.c_tag }별 유명한 카페를 한눈에! <br> WOW <br> ^오^ </p>
		 </div>
		...
		<div class="inner-in">
					...
					<li>
						<div class="cafeListBox">
						    <div class="cafeInfoImg">
						      <a href="${pageContext.request.contextPath}/cafe/cafe_detail_form.do?c_idx=${cafe.c_idx}"><img src="${pageContext.request.contextPath}/resources/upload/${cafe.c_photo}"></a>
						    </div>
			...
			<div class="pageBox">
		        ...
		        <c:forEach var="c" begin="1" end="${b}" varStatus="i">
		            <li><a href="${pageContext.request.contextPath}/cafe/cafe_tag.do?c_tag=${param.c_tag }&c_i=${i.count-1}">${i.count}</a></li>
		            </c:forEach>
		        </ul>
	     	</div>
